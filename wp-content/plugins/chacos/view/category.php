      ...
      <div class="swiper categorySwiper">
         <div class="swiper-wrapper">
            <div class="swiper-slide slide-col-item-category">
               ...
               <img src="<?= WIDGET_URL_CHACOS ?>/asset/img/sp1.png" class="w-100 img-banner-category">
               <div>
                     ...
                     <div id="flush-filter1" class="accordion-collapse collapse" aria-labelledby="flush-filter1"
                        ...
                        <div class="accordion-body body-item-filter">
                           ...
                           <div class="box-item-filter-small">
                              <button class="btn-size-item">5</button>
                              <button class="btn-size-item">6</button>
                              <button class="btn-size-item">7</button>
                              <button class="btn-size-item">8</button>
                              <button class="btn-size-item">9</button>
                              <button class="btn-size-item">10</button>
                           </div>
