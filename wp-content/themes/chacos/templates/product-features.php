...
<div class="box-product-features">
   <div class="w-100 position-relative">
      <img src="<?= get_template_directory_uri() ?>/assets/img/intro-bg.jpg" class="w-100 img-intro-desktop">
      <img src="<?= get_template_directory_uri() ?>/assets/img/intro-bg-mobile.jpg" class="w-100 img-intro-mobile">
   ...
   <div class="box-staraps">
      <div class="item-staraps">
         <img src="<?= get_template_directory_uri() ?>/assets/img/icon-adjust.png" alt="">
   ...
   <div class="box-our-fit">
      <img src="<?= get_template_directory_uri() ?>/assets/img/icon-luvseat.png" alt="">
      ...
      <img src="<?= get_template_directory_uri() ?>/assets/img/luv-bg.png" alt="">
      ...
      <div class="d-flex justify-content-center align-items-center">
         <img src="<?= get_template_directory_uri() ?>/assets/img/logo-luvseat.png" class="w-100 h-100"
            style="padding: 0 16px;">
         <img src="<?= get_template_directory_uri() ?>/assets/img/logo-ampa.png" class="w-100 h-100"
            style="padding: 0 16px;">
      </div>

   </div>
   <div class="box-ultimate">
      <img src="<?= get_template_directory_uri() ?>/assets/img/icon-durability.png" alt="">
      ...
      <img src="<?= get_template_directory_uri() ?>/assets/img/dura-bg.png" class="w-100">
   </div>
   <div class="box-outsoles">
      <img src="<?= get_template_directory_uri() ?>/assets/img/icon-outsoles.png" alt="">
      ...
      <div class="outsole-info">
         <div class="outsole-item" data-bs-toggle="modal" data-bs-target="#exampleModalVideo">
            <img src="<?= get_template_directory_uri() ?>/assets/img/outsoles-item.jpg" class="w-100">
         ...
         <div class="outsole-item">
            <img src="<?= get_template_directory_uri() ?>/assets/img/outsoles-item1.jpg" class="w-100">
            <p class="title-outsole-info">
   ...
   <div class="box-care">
      <img src="<?= get_template_directory_uri() ?>/assets/img/icon-sandal.png" alt="">
      <p class="title-starap">Outsoles</p>
      <p class="content-starap">Our performance outsoles are designed for traction and grip in the toughest
         environments.</p>
      <div class="outsole-info">
         <div class="outsole-item">
            <img src="<?= get_template_directory_uri() ?>/assets/img/sandal-item-0.jpg" class="w-100">
            <p class="title-outsole-info">
         ...
         <div class="outsole-item">
            <img src="<?= get_template_directory_uri() ?>/assets/img/sandal-item-1.jpg" class="w-100">
            <p class="title-outsole-info">
               Rechaco Repairs</p>
            <p class="content-outsole-info">
   ...
   <div class="modal fade" id="exampleModalVideo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <img src="<?= get_template_directory_uri() ?>/assets/img/xmark-solid.svg" data-bs-dismiss="modal"
         aria-label="Close" class="close-model-video">
