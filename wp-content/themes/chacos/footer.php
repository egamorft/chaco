      ...
      <div class="d-flex justify-content-between align-center flex-wrap">
         <div class="box-help">
            ...
            <div class="w-100 d-flex align-items-center">
               <div class="box-item-help">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/call.png" class="icon-contanct">
                  <span>(888) 211 - 1908</span>
               </div>
               <div class="box-item-help">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/chat.png" class="icon-contanct">
                  <span>Chat Now</span>
               </div>
            </div>
         </div>
         ...
         <div class="box-join">
            ...
            <div class="d-flex align-items-center justify-content-between">
               <img src="<?php echo get_template_directory_uri(); ?>/assets/img/instagram.png" class="icon-contanct">
               <img src="<?php echo get_template_directory_uri(); ?>/assets/img/tik-tok.png" class="icon-contanct">
               <img src="<?php echo get_template_directory_uri(); ?>/assets/img/pinterest.png" class="icon-contanct">
               <img src="<?php echo get_template_directory_uri(); ?>/assets/img/youtube.png" class="icon-contanct">
            </div>
         </div>
