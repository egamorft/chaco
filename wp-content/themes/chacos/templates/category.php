      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide-col-item-category">
            <div class="line-add-cart-slide ">
               <img src="<?= get_template_directory_uri() ?>/assets/img/add-to-cart.png">
               <span class="title-quick">Quick Add</span>
            </div>
            <div class="position-relative">
               <span class="tag-hot">NEW ARRIVAL</span>
               <img src="<?= get_template_directory_uri() ?>/assets/img/img-sp2.jpg" class="w-100 img-big-slide-sp">
               <div class="box-wishlist">
                  <div class="item-wishlist">
                     Wishlist
                  </div>
               </div>
               <img src="<?= get_template_directory_uri() ?>/assets/img/heart.svg" class="icon-heart"
                  onclick="toggleHeart(this)" onmouseover="toggleWishlist(this)" onmouseout="hideWishlist(this)">
                  ...
                  <div class="swiper swiperOptionColor">
                     <div class="swiper-wrapper">
                        <div class="swiper-slide slide-item-option-style"><img
                              src="<?= get_template_directory_uri() ?>/assets/img/img-sp3.jpg" class="img-option-color">
                        </div>
                        <div class="swiper-slide slide-item-option-style"><img
                              src="<?= get_template_directory_uri() ?>/assets/img/img-sp3.jpg" class="img-option-color">
                        </div>
                        ...
                        <div class="swiper-slide slide-item-option-style"><img
                              src="<?= get_template_directory_uri() ?>/assets/img/img-sp2.jpg" class="img-option-color">
                        </div>
                        <div class="swiper-slide slide-item-option-style"><img
                              src="<?= get_template_directory_uri() ?>/assets/img/img-sp3.jpg" class="img-option-color">
                        </div>
...
<div class="box-content-sp">
   ...
   <div class="box-line-filter-mobie">
      <div class="filter-mobile-left" data-bs-toggle="offcanvas" data-bs-target="#offcanvasFilterMobile"
         ...
         <img src="<?= get_template_directory_uri() ?>/assets/img/chevron.svg" style="width: 12px;">
      </div>
      ...
      <div class="box-sp">
         ...
         <div class="item-sp-filter">
            <div class="line-add-cart">
               <img src="<?= get_template_directory_uri() ?>/assets/img/add-to-cart.png" alt="">
               <span class="title-quick">Quick Add</span>
            </div>
            <div class="position-relative img-big-sp">
               <span class="tag-hot">NEW ARRIVAL</span>
               <img src="<?= get_template_directory_uri() ?>/assets/img/img-sp3.jpg" class="w-100 img-big-option">
               <div class="box-wishlist">
                  <div class="item-wishlist">
                     Wishlist
                  </div>
            ...
            <div>
               ...
               <div class="box-option-color-style">
                  <div class="swiper swiperOptionColor">
                     <div class="swiper-wrapper">
                        <div class="swiper-slide"><img src="<?= get_template_directory_uri() ?>/assets/img/img-sp2.jpg"
                              class="img-option-color">
                        </div>
                        <div class="swiper-slide"><img src="<?= get_template_directory_uri() ?>/assets/img/img-sp3.jpg"
                              class="img-option-color">
                        </div>
                        <div class="swiper-slide"><img src="<?= get_template_directory_uri() ?>/assets/img/img-sp3.jpg"
                              class="img-option-color">
               ...
               <img src="<?= get_template_directory_uri() ?>/assets/img/customize.png" class="w-100">
            </div>
         </div>
         <?php
    }
...
<!-- filter mobile -->
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasFilterMobile" aria-labelledby="offcanvasFilterMobile"
   style="width: 70%;">
