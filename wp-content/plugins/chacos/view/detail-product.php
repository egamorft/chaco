            ...
            <div class="swiper swiperImageBig">
               <div class="swiper-wrapper" id="lightgallery">
                  <div class="swiper-slide position-relative"
                     data-src="<?= WIDGET_URL_CHACOS ?>/asset/img/detail-sp1.png">
                     ...
                     <img src="<?= WIDGET_URL_CHACOS ?>/asset/img/detail-sp1.png"
                        data-src="<?= WIDGET_URL_CHACOS ?>/asset/img/detail-sp1.png" data-lg-size="1600-1067"
                        class="w-100" />
                     <div class="btn-search-zoom-img"><img src="<?= WIDGET_URL_CHACOS ?>/asset/img/search-sm.png"
         ...
         <div class="accordion" id="accordionExampleProduct" style="margin-right: 10px;">
            <div class="accordion-item accordion-item-infor">
               ...
               <div class="box-product-description">
                  ...
                  <div class="item-product-description">
                     <img src="<?= WIDGET_URL_CHACOS ?>/asset/img/noslipallgrip.svg">
               ...
               <div id="collapsetechnology" class="accordion-collapse collapse"
                  ...
                  <div class="accordion-body mb-3">
                     <div class="swiper swiperTechnilogy">
                        <div class="swiper-wrapper">
                           <div class="swiper-slide">
                              <img src="<?= WIDGET_URL_CHACOS ?>/asset/img/adjustment.jpg" class="w-100">
      ...
      <div class="box-detail-prduct-right">
         ...
         <div class="d-flex justify-content-between w-100 mt-5 mb-5">
            ...
            <div class="btn-heart-now">
               <img src="<?= WIDGET_URL_CHACOS ?>/asset/img/heart.svg" style="width: 45%;">
            </div>
         </div>
